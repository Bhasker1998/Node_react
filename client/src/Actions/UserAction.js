...
export const leave =(data)=>{
    return (dispatch)=>{
        console.log("sadfasdfasf",data)
        return axios.post('/api/leave',data).then((res)=>{
            console.log("leave response",res.status);
        }).catch((err)=>{
...
export const getdata = (data)=>{
    return (dispatch) =>{
        return axios.get("/api/getdata").then((res)=>{
            console.log("my name is get data", res);
                dispatch({
                    type:'DATA',
