              ...
              <Container>
                    <UncontrolledCollapse navbar toggler="#navbar_global">
                      <Nav className="align-items-lg-center" navbar>
                        ...
                        {/* <NavItem> 
                                  <NavLink className="nav-link-icon"  tag={Link}  to="/leave">leave</NavLink>
                                </NavItem> */}
                      </Nav>
                            ...
                            { isUserLoggedin &&
                              <UncontrolledDropdown nav>
                                ...
                                <DropdownMenu>
                                  ...
                                  <DropdownItem to="/leave" tag={Link}>Apply leave</DropdownItem>
                                  <DropdownItem to="/leavelist" tag={Link}>leave status</DropdownItem>
                                  {/* <DropdownItem to="/rough" tag={Link}>rough</DropdownItem> */}
